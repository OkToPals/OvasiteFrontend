  ...
  return (
    ...
    <>
      <article className="w-[100%] mini:w-[48%] md:w-[48%] lg:w-[32%] md:h-[25.7rem] h-[18rem] shadow-sm p-4 border-[#ddd] bg-white border rounded-lg">
        ...
        <div
          ...
          className="mx-auto md:w-[12.5rem] md:h-[12.5rem] w-[6.25rem] h-[6.25rem]  
                rounded-full bg-[#cac0b3] mt-[1rem]"
        >
          {organizationImage ? (
            <img
              src={organizationImage}
              alt="Profile picture of Jane Doe"
              className="md:w-[12.5rem] md:h-[12.5rem] w-[6.25rem] h-[6.25rem]  rounded-full"
            />
          ) : (
            <svg
        ...
        <h2
          className="max-w-[80%] mx-auto mt-2 overflow-hidden 
                whitespace-nowrap text-ellipsis font-bold text-[1em] md:text-[1.2em] text-center"
        >
          {name.title} {name.first} {name.last}
        </h2>
        <h2 className="text-[1em] md:text-[1em] text-center overflow-wrap break-words text-[#5C5C5C] mt-2 ">
          {numberOfEmployees}
        </h2>
      ...
      {showDeleteModal ? 
        ...
        url 
        id={id} 
        handleCancelBtn={ToggleDeleteModal}
        handleConfirmBtn ={handleDeleteTeam} 
        loading={loading}
        /> 
        : null
    }
