      ...
      <div id="frame22">
        ...
        <div style={{ textAlign: "right" }} id="text">
          <div id="text">
            ...
            >
              Our platform is designed to enhance teamwork by offering a suite
              of powerful collaboration features that enable you to work
              seamlessly with your colleagues, share valuable insights, and
              collectively arrive at smart solutions.{" "}
            </p>
          </div>
        </div>
      </div>
