  ...
  return (
    ...
    <article className="w-[100%] mini:w-[48%] md:w-[48%] lg:w-[32%] md:h-[25.7rem] h-[18rem] shadow-sm p-4 border-[#ddd] bg-white border rounded-lg">
        ...
        <div role="img" aria-label="Profile picture of Jane Doe" 
            ...
            {
                profileImage ? 
                    <img src={profileImage} alt="Profile picture of Jane Doe" className="md:w-[12.5rem] md:h-[12.5rem] w-[6.25rem] h-[6.25rem] rounded-full"/> 
                :
        ...
        <h2 className="text-[1em] md:text-[1.25em] text-center overflow-wrap break-words">{email}</h2>
        <h2 className="text-[0.8em] md:text-[1em] text-center">{phone}</h2>
    ...
    {showDeleteModal ? 
        ...
        handleConfirmBtn ={handleDeleteEmployee} 
        loading={loading}
        /> 
        : null
    }
