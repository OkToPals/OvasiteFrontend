...
const OrganizationCard = ({
  ...
  const [loadingDeleteOrganization, setLoadiDeleteOrganization] =
    useState(false);
    ...
    <article className="w-[100%] mini:w-[48%] md:w-[48%] lg:w-[32%] md:h-[25.7rem] h-[18rem]  shadow-sm p-4 border-[#ddd] bg-white border rounded-lg hover:cursor-pointer">
      <Link href={`/organizations/${org_id}`}>
        ...
        <div
          ...
          className="mx-auto md:w-[12.5rem] md:h-[12.5rem] w-[6.25rem] h-[6.25rem]  
                rounded-full border-[#cac0b3] border flex flex-row justify-center items-center"
        >
          {organizationImage ? (
            <img
              src={organizationImage}
              alt="Profile picture of Jane Doe"
              className="mx-auto md:w-[12.5rem] md:h-[12.5rem] w-[6.25rem] h-[6.25rem] rounded-full"
            />
          ) : (
        ...
        <h2
          className="max-w-[80%] mx-auto mt-1 overflow-hidden 
                whitespace-nowrap text-ellipsis font-bold text-[1em] md:text-[1.25em] text-center"
        >
          {name}
        </h2>
        <h2 className="text-[1.25em] text-center overflow-wrap break-words">
          {numberOfEmployess}
        </h2>
        ...
        >
          ...
          <span className="text-ova_white text-[1em] ">Add Project</span>
        </button>
      </Link>
      ...
      {toggleEdit ? (
        <EditOrganizationModal
          handleCancelBtn={ToggleEditOrganization}
          isEditOrganizationModalActive={true}
